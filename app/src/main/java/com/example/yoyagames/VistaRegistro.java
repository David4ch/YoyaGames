...
public class VistaRegistro extends ComponentActivity {
                            ...
                            db.collection("users").document(userId)
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            Toast.makeText(VistaRegistro.this, "Registro exitoso", Toast.LENGTH_SHORT).show();
                                            cambiar();
                                        }
                                    })
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            ...
                                            Toast.makeText(VistaRegistro.this, "Error al registrar usuario", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        } else {
